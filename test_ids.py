...
def main():
    ...
    accuracy, f1, precision, recall = get_scores(attack_class, predictions)
...
def load_data(options):
    attributes_dataframe, _, attack_class_dataframe = preprocess(load_test(), selected_attack_class=options.attack_class)
